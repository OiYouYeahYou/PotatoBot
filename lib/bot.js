...
var prefix = ';', prefixHelp = '?';
botCommands.verifyBotCommands();
//  //  //  //  //  Client
const clientOptions = { fetchAllMembers: true };
exports.client = new Discord.Client(clientOptions);
exports.client.on('ready', ready);
exports.client.on('message', messageRecived); // Diff function to event
exports.client.on('guildMemberAdd', guildMemberAdd);
exports.client.on('guildMemberRemove', guildMemberRemove);
exports.client.login(process.env.discord);
//  //  //  //  //  Event Functions
...
function messageRecived(message) {
    ...
    if (!u.validatePrefix(prefix, content))
        return;
    ...
    if (func)
        ...
        result = true;
    if (result)
        botCommands.help(message, command, result);
